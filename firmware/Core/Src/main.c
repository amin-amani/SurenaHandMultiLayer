...
uint8_t hal_spi_transmit(uint8_t* data, uint16_t len, uint32_t timeout)
{
	return HAL_SPI_Transmit(&hspi1, data, len, timeout);
}

uint8_t hal_spi_receive(uint8_t* data, uint16_t len, uint32_t timeout)
{
